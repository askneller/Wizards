...
public class Spells {
    ...
    public static final Spell SUMMON_ZOMBIE = new Spell("Zombie", SummonedCreatureZombie.class, SUMMONED_ZOMBIE, ManaColor.COLORLESS);
    ...
    static {
        spellsByName.put(SummonedCreatureZombie.key, SUMMON_ZOMBIE);
